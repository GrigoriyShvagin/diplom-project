    ...
    >
        ...
        <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
          <form onSubmit={submit} style={{ width: "100%", maxWidth: 420 }}>
            <h1 style={{ fontSize: 40, marginBottom: 10, lineHeight: 1.1, fontWeight: 600 }}>
              {isLogin ? (
                <>
                  С <span className="display-italic">возвращением</span>
                </>
              ) : (
                <>
                  Создайте <span className="display-italic">аккаунт</span>
                </>
              )}
            </h1>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <input
                ...
                style={errors.password ? errStyle : undefined}
              />
      ...
      >
        ...
        >
          ...
          <path
            d="M 0 600 L 100 480 L 220 540 L 380 440 L 540 530 L 600 500 L 600 800 L 0 800 Z"
            fill="url(#auth-stripes)"
            opacity="0.85"
          />
          <path
            d="M 0 700 L 140 620 L 320 660 L 480 600 L 600 640 L 600 800 L 0 800 Z"
            fill="oklch(0.20 0.04 220)"
            opacity="0.7"
          />
          <path
            d="M 60 720 Q 200 680 360 700 T 580 690"
            stroke="var(--paper)"
            strokeWidth="2"
            fill="none"
            strokeDasharray="3 5"
